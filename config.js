...
When sending a message, ensure that it is readable to the user. This means that typing styles that adding underscores all throughout your message is prohibited. No exceptions, unless it is within an appropriate context.
